...
const TreeViewInsertTarget = (
  props: TreeViewInsertTargetProps & TreeViewInsertTargetDropProps
) =>
...
const handleCanDrop = (
  ...
  ) && !item.allSourceIDs.contains(props.parentNode ? props.parentNode.id : "");
...
const nodeTarget: DropTargetSpec<TreeViewInsertTargetProps> = {
  ...
  canDrop: (props, monitor) =>
    handleCanDrop(props, monitor, monitor.getItem() as DraggedNode)
};

const collectNodeDropProps = (
  connect: DropTargetConnector,
  monitor: DropTargetMonitor
): TreeViewInsertTargetDropProps => ({
  connectDropTarget: connect.dropTarget(),
  canDrop: monitor.canDrop(),
  isDropping: monitor.isOver({ shallow: true }) && monitor.canDrop()
});

export const DroppableTreeViewInsertTarget: React.ComponentClass<
  TreeViewInsertTargetProps
