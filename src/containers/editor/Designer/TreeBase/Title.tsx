...
export const Title = (props: any) => {
  ...
  let statusObj: any = {}
  if (dataRef.type && dataRef.value) {
    statusObj = loadFileStatus(dataRef.type, dataRef.value)
  }
  let status = 'normal',
    newPath = ''
  ...
  // dnd
  let drag
  if (!_.isEmpty(dataRef.value)) {
    const templateSchema = {
      $template: dataRef.value, // this will be parsed on ide's template parser
